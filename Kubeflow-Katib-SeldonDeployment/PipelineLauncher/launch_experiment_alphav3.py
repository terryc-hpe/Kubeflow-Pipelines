...
if __name__ == "__main__":
    ...
    print (args.experiment_spec, type(args.experiment_spec))
    experiment_spec = json.loads(args.experiment_spec)
    print("---------------------------------")
    print (experiment_spec, type(experiment_spec))
    ...
    if katib_client.is_experiment_succeeded(name=experiment_name, namespace=experiment_namespace):
        ...
        optimal_hp = katib_client.get_optimal_hyperparmeters(
